...
public class Board {
	...
	public Board(Integer board_id, String writer_id, String writer_pw, String write_title, String write_content, 
				Date write_date, Integer write_view, Integer write_recommend, Integer write_not_recommend) {
	...
	// Getter를 만들어 놓으면 JSP의 EL에서는 필드가 있는것처럼 사용할 수 있다.
	public String getCreationDateTime() {
		// Date 타입을 날짜 비교하기 편하도록 LocalDate 타입으로 변환
		
		// (1) DTO에는 java.util.Date 타입으로 설정되어 있음
		// (2) rs.getDate()로 꺼내면 java.sql.Date 타입으로 꺼내짐
	...
	public void setWrite_content(String wrtie_content) {
		this.write_content = wrtie_content;
	}
