<%@ page language="java" contentType="text/html; charset=EUC-KR"
    pageEncoding="EUC-KR"%>
<%
	// attribute는 Object 타입으로 등록되기 때문에 자유롭게 사용하기 위해서는
	// 다운 캐스팅이 필요하다.
...
<body>
	...
	<h1># 포워드 후에 남아 있는 어트리뷰트 값들 확인하기</h1>
	...
	<ul>
		...
		<li>
			...
			(한 번 등록하고나면 웹 브라우저를 끌 때까지 유지됨)		
		</li>
		<li>
			application: <%=application.getAttribute("food") %>
			(한 번 등록하고나면 서버를 끌 때까지 유지됨)
		</li>
	</ul>
	...
	<h3># EL로 각 필드값에 접근하기 (해당 객체의 Getter가 구현되어 있어야함)</h3>
