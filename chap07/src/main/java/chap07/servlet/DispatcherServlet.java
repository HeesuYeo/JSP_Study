...
// business 패키지 내부의 모든 것을 임포트
import chap07.business.BusinessLogic;
import chap07.business.HelloBusinessLogic;
import chap07.business.OrderFormBusinessLogic;
import chap07.business.OrderListBusinessLogic;
import chap07.business.OrderInsertBusinessLogic;
...
public class DispatcherServlet extends HttpServlet{
	...
	public void init(ServletConfig config) throws ServletException {
		...
		businessMapping.put("/pizza/order/orderForm", new OrderFormBusinessLogic());
		businessMapping.put("/pizza/order/orderSummary", new OrderInsertBusinessLogic());
		businessMapping.put("/pizza/order/result", new PizzaOrderResultBusinessLogic());
		businessMapping.put("/pizza/order/orderList", new OrderListBusinessLogic());
	}
