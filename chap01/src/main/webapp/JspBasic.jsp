...
<body>
	...
	<ul>
		...
		<li>요청에 따라 다른 응답을 생성하지는 못 한다.</li>
		<li>그림 주세요 -> 그림을 준다</li>
	...
	<ul>
		...
		<li>
			프로그래밍 언어를 사용하여 DB에 접속하는 등의 로직을 수행할 수 있다.
		</li>
		<li>동적 컨텐츠 처리</li>
	</ul>
	
	<!-- 
		apache : 웹 서버(html, css, js... 등 처리)
		tomcat : 웹 애플리케이션 서버(jsp ... 등 처리) 
	-->
	...
	<ul>
		...
		<!-- 
			.jsp 내부에는 html, css, js, Java, JSP가 다 들어가서 유지 보수 힘듦
			JSP의 단점을 보완하기 위해 사용되는게 Spring
		 -->
	</ul>
	
	<!-- Java는 Tomcat이 해석한다. (Server) -->
	<!-- JavaScript는 Chrome이 해석한다. (Client) -->

	<%-- JSP Script --%>
	
	<%--
		<%  %> : 자바 코드를 사용할 수 있는 영역 (메서드 내부 취급(메서드 선언 X))
