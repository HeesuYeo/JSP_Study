...
<body>
	...
	<ul>
		<li>통신 규약</li>
		<li>통신의 절차를 규정하고 해당 절차에 이름을 붙이는 것</li>
	...
	<ol>
		<li>
			사용자(클라이언트, Client)가 웹 브라우저의 주소창에 보고 싶은 페이지의 URL을 입력한다.
			(링크를 클릭하는 것도 주소창에 URL을 입력하는 것과 같은 효과가 있다.) 
		</li>

		<li>
			웹 브라우저는 URL에 포함된 호스트의 IP주소를 통해 해당 웹 서버로 요청(Request)을 보낸다.
		</li>
		<li>
		...
		<li>
			응답을 받은 클라이언트의 웹 브라우저가 해당 응답을 해석하여 클라이언트에게 보여준다.
		</li>
	</ol>
	...
	<ul>
		...
		<li>
			URL의 IP주소 대신 도메인 이름을 사용하면 근처의 DNS 서버에서
