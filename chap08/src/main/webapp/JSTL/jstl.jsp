...
<%
	// ※ 비지니스 로직에서 어트리뷰트에 추가한 후 포워드로 받았다고 가정한다.
...
<body>
	...
	<dl>
		...
		<dt>&lt;c:if&gt;</dt>
		<dd>if문을 편리하게 수행할 수 있지만, else if 와 else는 없다.</dd>
	...
	<c:set var="waffle" value="mange" scope="session"/>
	...
	<c:choose>
		<c:when test="${score > 100 || score < 0 }"></c:when>
